...
int main(void) { //main header
    ...
    while ((grade = getchar()) != EOF) { //while loop
        ...
        else if (grade == 'b' || grade == 'B') { //else if grade is b or B
            ++bCount; //increment number of b's
        } //end else if
        else if (grade == 'c' || grade == 'C') { //if grade is c or C
            ++cCount; //increment number of c's
        } //end else if
        else if (grade == 'd' || grade == 'D') { //if grade is d or D
            ++dCount; //increment number of d's
        } //end else if
        else if (grade == 'f' || grade == 'F') { //if grade is f or F
            ++fCount; //increment number of f's
        } //end else if
        else if (grade == '\n' || grade == '\t' || grade == ' ') { //if grade is newline, tab, or space
            continue; //keep going with loop
        } //end else if
